...
# Email
# EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'  # run this one for production
EMAIL_BACKEND = 'myApp.email_backend.UnverifiedEmailBackend'    # run this one for developement
